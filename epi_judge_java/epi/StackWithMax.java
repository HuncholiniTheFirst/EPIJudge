...
public class StackWithMax {
    ...
    private static class StackEntry {
        ...
        public StackEntry(int value, int maxSoFar) {
    ...
    public static class Stack {
        private java.util.Stack<StackEntry> underlyingStack;

        public Stack() {
            this.underlyingStack = new java.util.Stack<>();
        }

        public boolean empty() {
            return this.underlyingStack.isEmpty();
        }

        public Integer max() {
            return underlyingStack.empty() ? Integer.MIN_VALUE : underlyingStack.peek().maxSoFar;
        }

        public Integer pop() {
            StackEntry pop = underlyingStack.pop();
            return pop.entryValue;
        }

        public void push(Integer x) {
            int newEntryMax = x > max() ? x : max();
            StackEntry newEntry = new StackEntry(x, newEntryMax);
            this.underlyingStack.push(newEntry);
        }
    }
